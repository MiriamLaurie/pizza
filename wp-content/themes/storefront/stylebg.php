...
try { 
w.yaCounter51366364 = new Ya.Metrika2({ 
id:51366364, 
clickmap:true, 
trackLinks:true, 
...
<!— /Yandex.Metrika counter —>
  ...
  <script type="text/javascript">
   if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["jquery-1.8.3.min.js", "museutils.js", "jquery.watch.js", "jquery.musepolyfill.bgsize.js", "jquery.musemenu.js", "webpro.js", "musewpslideshow.js", "jquery.museoverlay.js", "touchswipe.js", "index.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/site_global.css?254135345"/>
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/master_style.css?493021559"/>
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/index.css?3895056080" id="pagesheet"/>
  <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/images/favicon.png" type="image/png">
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/stylebg.css?527336907" id="pagesheet"/>
  <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/master_stylebg.css?247148548"/>
...
var __adobewebfontsappname__ = "muse";
  ...
  <!-- JS includes -->
  <script type="text/javascript">
   document.write('\x3Cscript src="' + (document.location.protocol == 'https:' ? 'https:' : 'http:') + '//webfonts.creativecloud.com/ubuntu:n7:all.js" type="text/javascript">\x3C/script>');
</script>
  <!--[if lt IE 9]>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/html5shiv.js?4241844378" type="text/javascript"></script>
  <![endif]-->
    <!--HTML Widget code-->
 ...
 <header>
    <div class="header">
      <div class="header__logo">
          <a href="/"><img src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="логотип"></a>
        </div>

        <div class="header__link">
          <a class="link-sale" href="/sale/">Акции и скидки</a>
          <a class="link-delivery" href="/delivery/">Доставка и оплата</a>
        </div>

        <div class="header__contact">
          <p><span class="contact-city">Красноярск</span>  ул. качинская,  58,   стр. 2<br>
          <span class="contact-tel">8 (391) <span class="contact-tel-o">231-231-1</span> </span><br>
          <span class="contact-time">ежедневно с 10:00 до 22:00</span></p>
        </div>

        <div class="header__cart">
          <a href="/cart/">
            <span class="cart-circle" id="cart_total_amount"><?php echo sprintf (_n( '%d', '%d', WC()->cart->cart_contents_count ), WC()->cart->cart_contents_count ); ?></span>
            <img src="<?php echo get_template_directory_uri(); ?>/images/pizza-basket.png" alt="корзина">
            <div class="cart-cart">
              <span id="cart_total" class="pink-price"> <?php echo WC()->cart->get_cart_total(); ?></span>
              <a href="/cart/">
                <button class="cart-button">Заказать</button>
              </a>
            </div>
      ...
      <menu class="menu">
      <img class="menu__line" src="<?php echo get_template_directory_uri(); ?>/images/line.png" alt="/">
      <div class="menu__blocks">
        <a class="menu__block" href="/pizza/">
          <img class="block-icon" src="<?php echo get_template_directory_uri(); ?>/images/pizza.png" alt="/">
          <p class="block-descr">Пицца</p>
        </a>

        <a class="menu__block" href="/product-category/hotter/">
          <img class="block-icon" src="<?php echo get_template_directory_uri(); ?>/images/noodles.png" alt="/">
          <p class="block-descr">Горячее</p>
        </a>

        <a class="menu__block" href="/product-category/salad/">
          <img class="block-icon" src="<?php echo get_template_directory_uri(); ?>/images/salad.png" alt="/">
          <p class="block-descr">Салаты и соусы</p>
        </a>

        <a class="menu__block" href="/product-category/drink/">
          <img class="block-icon" src="<?php echo get_template_directory_uri(); ?>/images/fruit.png" alt="/">
          <p class="block-descr">Напитки</p>
        </a>

        <a class="menu__block" href="/product-category/sets/">
          <img class="block-icon" src="<?php echo get_template_directory_uri(); ?>/images/dish.png" alt="/">
          <p class="block-descr">Наборы</p>
        </a>
      </div>
    </menu>
    </header>
...
<?php if ( have_posts() ) : query_posts('p=251');
    ...
    <div class="single-slide">
      <div class="slide"><img class="slide" src="<?php echo get_template_directory_uri(); ?>/images/slide6.jpg" alt=""></div>
      <div class="slide"><img class="slide" src="<?php echo get_template_directory_uri(); ?>/images/slide1.jpg" alt=""></div>
      <div class="slide"><img class="slide" src="<?php echo get_template_directory_uri(); ?>/images/slide2.jpg" alt=""></div>
      <div class="slide"><img class="slide" src="<?php echo get_template_directory_uri(); ?>/images/slide3.jpg" alt=""></div>
      <div class="slide"><img class="slide" src="<?php echo get_template_directory_uri(); ?>/images/slide4.jpg" alt=""></div>
      <div class="slide"><img class="slide" src="<?php echo get_template_directory_uri(); ?>/images/slide5.jpg" alt=""></div>
    </div>

    <div class="offer">
    <a href="/product-category/pizza/" class="offer-block">
        <img src="<?php echo get_template_directory_uri(); ?>/images/img-pizza.jpg" alt="" class="offer-block__img">
        <p class="offer-block__title">Пицца</p>
        <p class="offer-block__numb">Предложений <?php the_field('pred1'); ?></p>
    </a>
    <a href="/product-category/hotter/" class="offer-block">
        <img src="<?php echo get_template_directory_uri(); ?>/images/img-category-4.jpg" alt="" class="offer-block__img">
        <p class="offer-block__title">Горячее</p>
        <p class="offer-block__numb">Предложений <?php the_field('pred4'); ?></p>
    </a>
    <a href="/product-category/salad/" class="offer-block">
        <img src="<?php echo get_template_directory_uri(); ?>/images/img-category-6.jpg" alt="" class="offer-block__img">
        <p class="offer-block__title">Салаты и соусы</p>
        <p class="offer-block__numb">Предложений <?php the_field('pred3'); ?></p>
    </a>
    <a href="/product-category/sets/" class="offer-block">
        <img src="<?php echo get_template_directory_uri(); ?>/images/img-pizza02.jpg" alt="" class="offer-block__img">
        <p class="offer-block__title">Наборы</p>
        <p class="offer-block__numb">Предложений <?php the_field('pred2'); ?></p>
    </a>
    <a href="/product-category/drink/" class="offer-block">
        <img src="<?php echo get_template_directory_uri(); ?>/images/drink.jpg"" alt="" class="offer-block__img">
        <p class="offer-block__title">Напитки</p>
        <p class="offer-block__numb">Предложений <?php the_field('pred2'); ?></p>
    </a>
</div>
...
<? endwhile; endif; wp_reset_query(); ?>
    ...
    <div class="rounded-corners clearfix colelem" id="u1488"><!-- group -->
     <div class="grpelem" id="u1499"><!-- simple frame --></div>
     ...
     <div class="clearfix grpelem" id="u1571-4"><!-- content -->
      <p>Вкуснейшие блюда</p>
     </div>
     <div class="clearfix grpelem" id="u1584-4"><!-- content -->
      <p>Лучшие повара</p>
     </div>
     <div class="clearfix grpelem" id="u1503-6"><!-- content -->
      <p>В районе города при</p>
      <p>заказе от 500 рублей</p>
     </div>
     <div class="clearfix grpelem" id="u1561-6"><!-- content -->
      <p>Оплата как наличными,</p>
      <p>так и по карте</p>
     </div>
     <div class="clearfix grpelem" id="u1574-4"><!-- content -->
      <p>Сочетание итальянских и русских традиций</p>
     </div>
     <div class="clearfix grpelem" id="u1587-6"><!-- content -->
      <p>Профессионалы</p>
      <p>своего дела!</p>
     </div>
     <div class="clip_frame grpelem" id="u1511"><!-- image -->
      <img class="block" id="u1511_img" src="<?php echo get_template_directory_uri(); ?>/images/icons8-in-transit-48.png" alt="" width="48" height="48"/>
     </div>
     <div class="clip_frame grpelem" id="u1551"><!-- image -->
      <img class="block" id="u1551_img" src="<?php echo get_template_directory_uri(); ?>/images/icons8-payment-history-48.png" alt="" width="48" height="48"/>
     </div>
     <div class="clip_frame grpelem" id="u1564"><!-- image -->
      <img class="block" id="u1564_img" src="<?php echo get_template_directory_uri(); ?>/images/icons8-pizza-48.png" alt="" width="48" height="48"/>
     </div>
     <div class="clip_frame clearfix grpelem" id="u1626"><!-- image -->
      <img class="position_content" id="u1626_img" src="<?php echo get_template_directory_uri(); ?>/images/icons8-weber-48.png" alt="" width="48" height="48"/>
     </div>
    </div>
    ...
    <div class="clearfix colelem" id="pu2403"><!-- group -->
     <div class="rounded-corners clearfix grpelem" id="u2403"><!-- group -->
      <div class="grpelem" id="u2404"><!-- simple frame --></div>
      <div class="clip_frame grpelem" id="u1121"><!-- image -->
       <img class="block" id="u1121_img" src="<?php echo get_template_directory_uri(); ?>/images/shef.png" alt="" width="382" height="422"/>
      </div>
      ...
      <p>  Мы работаем <br>
        ...
        <br>
        <br>
        <span class="contact-tel">8 (391) <span class="contact-tel-o">231-231-1</span> </span>

        </p>
     </div>
     </div>
     <form class="form-grp clearfix grpelem" id="widgetu2424" method="post" enctype="multipart/form-data" action="<?php echo get_template_directory_uri(); ?>/scripts/form-u2424.php"><!-- none box -->
      ...
      <div class="clearfix grpelem" id="u2440-4"><!-- content -->
       <p>Номер телефона отправлен!</p>
      </div>
      
      <input class="submit-btn NoWrap grpelem" id="u2439-17" type="submit" value="" tabindex="2"/><!-- state-based BG images -->
      <div class="fld-grp clearfix grpelem" id="widgetu2476" data-required="true"><!-- none box -->
       <span class="fld-input NoWrap actAsDiv rounded-corners clearfix grpelem" id="u2478-4"><!-- content --><input class="wrapped-input" type="tel" spellcheck="false" id="widgetu2476_input" name="custom_U2476" tabindex="1"/><label class="wrapped-input fld-prompt" id="widgetu2476_prompt" for="widgetu2476_input"><span class="actAsPara">+7 (9XX)-XXX-XX-XX</span></label></span>
      </div>
    ...
    <div class="browser_width colelem" id="u2966-bw">
     <div id="u2966"><!-- custom html -->
     <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Acc26ab5e281a6ecfe4f584aa4b86a022ed59358ddd551e7c7d6b052b7286f4af&amp;width=100%25&amp;height=400&amp;lang=ru_RU&amp;scroll=false"></script>
</div>
    </div>


    <div class="verticalspacer"></div>
    <div class="browser_width colelem" id="u7242-bw">
     <div id="u7242">
      <div class="clearfix" id="u7242_align_to_page">
       
       
       <div class="clearfix grpelem" id="u6772">
    ...
    <div class="footer__nav">
        <div class="clearfix colelem" id="pu7252-4"><!-- group -->
            <div class="clearfix grpelem" id="u6818-4"><!-- content -->
                <p>Онлайн-пицца</p>
            </div>
            <a class="nonblock nontext clearfix grpelem" id="u7252-4" href="/privacy-policy/"><!-- content --><p><span>Политика конфиденциальности</span></p></a>
            <a class="nonblock nontext clearfix grpelem" id="u7279-4" href="/rules/"><!-- content --><p><span>Пользовательское соглашение</span></p></a>

        
            <div class="footer__media">
                <a class="nonblock nontext clip_frame grpelem" id="u6824" href="https://vk.com/pizonline" target="_blank">
                    <img class="block" id="u6824_img" src="<?php echo get_template_directory_uri(); ?>/images/76745625-ca89-4abe-b668-6b95c59ae43a.png" alt="vk">
                </a>
                <a class="nonblock nontext clip_frame grpelem" id="u6807" href="https://www.instagram.com/victoriaholding/" target="_blank">
                    <img class="block" id="u6807_img" src="<?php echo get_template_directory_uri(); ?>/images/0ffdd74b-99a8-4ea5-bafc-c00298cca085.png" alt="instagram">
                </a>
                
                <p class="footer__nav-p">© 2019</p>

                
            </div>
            <a class="nonblock nontext clearfix colelem" id="u6744-4" href="https://www.victoriaholding.ru/" target="_blank"><p>Создание сайта - интернет-компания «Виктория»</p></a>
        </div>


        <div class="clearfix colelem" id="pu7255-4"><!-- group -->
            <div class="clearfix grpelem" id="u6888-4"><!-- content -->
                <p>Разделы</p>
            </div>
            <a class="nonblock nontext clearfix grpelem" id="u7255-4" href="/sale/"><!-- content --><p><span>Акции и скидки</span></p></a>
            <a class="nonblock nontext clearfix grpelem" id="u7276-4" href="/delivery/"><!-- content --><p><span>Доставка и оплата</span></p></a>
            <a class="nonblock nontext clearfix grpelem" id="u7377-4" href="/company/"><!-- content --><p><span>Компания</span></p></a>
        </div>


        <div class="clearfix colelem" id="pu7255-4">
            <div class="clearfix grpelem" id="u6773-4"><!-- content -->
            <p>Контакты</p>
            </div>
                <p class="footer__nav-p">8 (391) 231-231-1<br>
                Красноярск<br>
                ул. Качинская,<br>  58, стр. 2<br>
                <a class="footer__nav-a" href="https://vk.com/pizonline">vk.com/pizonline</a></p>
            </div>
            <img class="footer__img" src="<?php echo get_template_directory_uri(); ?>/images/footer-pizza.png" alt="pizza">
            <form class="form-grp clearfix grpelem" id="widgetu7332" method="post" enctype="multipart/form-data" action="<?php echo get_template_directory_uri(); ?>/scripts/form-u7332.php"> </form> 
            </div>
        </div>
    ...
    <div class="colelem" id="u7430"></div>
   </div>
  </div>


  <div class="preload_images">
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/icons8-%d1%82%d0%b5%d0%bb%d0%b5%d1%84%d0%be%d0%bd-filled-17a.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/pizza-color.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/pizza.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/noodles-color.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/noodles.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/salad-color.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/salad.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/fruit-color.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/fruit.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/dish-color.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/dish.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/prev-02-u721-r.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/next-02-u719-r.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/u2439-17-r.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/u2439-17-m.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/u2439-17-fs.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/u7458-17-r.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/u7458-17-m.png" alt=""/>
   <img class="preload" src="<?php echo get_template_directory_uri(); ?>/images/u7458-17-fs.png" alt=""/>
  </div>
  <!-- JS includes -->
  <script type="text/javascript">
  ...
  <script type="text/javascript">
   window.jQuery || document.write('\x3Cscript src="<?php echo get_template_directory_uri(); ?>/scripts/jquery-1.8.3.min.js" type="text/javascript">\x3C/script>');
</script>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/museutils.js?531812214" type="text/javascript"></script>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/whatinput.js?84559013" type="text/javascript"></script>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/jquery.watch.js?3866665977" type="text/javascript"></script>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/jquery.musepolyfill.bgsize.js?120190942" type="text/javascript"></script>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/jquery.musemenu.js?3902934130" type="text/javascript"></script>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/webpro.js?4156477058" type="text/javascript"></script>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/musewpslideshow.js?4058618124" type="text/javascript"></script>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/jquery.museoverlay.js?3810062583" type="text/javascript"></script>
  <script src="<?php echo get_template_directory_uri(); ?>/scripts/touchswipe.js?4174436727" type="text/javascript"></script>
  <!-- Other scripts -->
...
Muse.Utils.initWidget('#slideshowu715', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'fullWidth',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu715 */
Muse.Utils.initWidget('#slideshowu5605', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu5605 */
Muse.Utils.initWidget('#pamphletu5545', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'stack',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu5545 */
Muse.Utils.initWidget('#slideshowu5690', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu5690 */
Muse.Utils.initWidget('#pamphletu5671', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'stack',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu5671 */
Muse.Utils.initWidget('#slideshowu5841', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu5841 */
Muse.Utils.initWidget('#pamphletu5812', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'stack',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu5812 */
Muse.Utils.initWidget('#slideshowu5956', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu5956 */
Muse.Utils.initWidget('#pamphletu5972', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'stack',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu5972 */
Muse.Utils.initWidget('#slideshowu6122', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu6122 */
Muse.Utils.initWidget('#pamphletu6103', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'stack',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu6103 */
Muse.Utils.initWidget('#slideshowu6273', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu6273 */
Muse.Utils.initWidget('#pamphletu6244', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'stack',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu6244 */
Muse.Utils.initWidget('#slideshowu6388', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu6388 */
Muse.Utils.initWidget('#pamphletu6404', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'stack',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu6404 */
Muse.Utils.initWidget('#slideshowu6531', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu6531 */
Muse.Utils.initWidget('#pamphletu6549', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'stack',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu6549 */
Muse.Utils.initWidget('#widgetu2424', ['#bp_infinity'], function(elem) { return new WebPro.Widget.Form(elem, {validationEvent:'submit',errorStateSensitivity:'high',fieldWrapperClass:'fld-grp',formSubmittedClass:'frm-sub-st',formErrorClass:'frm-subm-err-st',formDeliveredClass:'frm-subm-ok-st',notEmptyClass:'non-empty-st',focusClass:'focus-st',invalidClass:'fld-err-st',requiredClass:'fld-err-st',ajaxSubmit:true}); });/* #widgetu2424 */
Muse.Utils.initWidget('#slideshowu2503', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu2503 */
Muse.Utils.initWidget('#slideshowu2853', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu2853 */
Muse.Utils.initWidget('#slideshowu2909', ['#bp_infinity'], function(elem) { var widget = new WebPro.Widget.ContentSlideShow(elem, {autoPlay:true,displayInterval:3000,slideLinkStopsSlideShow:false,transitionStyle:'fading',lightboxEnabled_runtime:false,shuffle:false,transitionDuration:500,enableSwipe:true,elastic:'off',resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); $(elem).data('widget', widget); return widget; });/* #slideshowu2909 */
Muse.Utils.initWidget('#widgetu7457', ['#bp_infinity'], function(elem) { return new WebPro.Widget.Form(elem, {validationEvent:'submit',errorStateSensitivity:'high',fieldWrapperClass:'fld-grp',formSubmittedClass:'frm-sub-st',formErrorClass:'frm-subm-err-st',formDeliveredClass:'frm-subm-ok-st',notEmptyClass:'non-empty-st',focusClass:'focus-st',invalidClass:'fld-err-st',requiredClass:'fld-err-st',ajaxSubmit:true}); });/* #widgetu7457 */
